...
if(localStorage.getItem('office')){
  ...
  Api.get('/workerData/registration',{
    headers:{
  ...
  .then((result)=>{
    ...
    employeesData=employeesData.map((ele)=>{
      return({...ele,imgPath:apiUrl+ele.imgPath})
    })
  })
...
import Api from './../config/Config';
import Api from './../../../User-Dashboard/src/config/Config';
import { useNavigate } from 'react-router-dom';
...
export const guaranteeGrid = [
  { headerText: 'Guarantee ID',
    width: '150',
    textAlign: 'Center',
    field: 'id'},
    { headerText: 'Order ID',
  ...
  { headerText: 'Guarantee Days left',
    width: '135',
    field: 'date',
    textAlign: 'Center' },
];
export const employeesGrid = [
  { field: 'id',
    headerText: 'ID',
    headerText_ar: 'رقم العامل',
    width: '60',
    textAlign: 'Center' },
  {
    headerText: 'Image',
    headerText_ar: 'العمال',
    width: '60',
    ...
    template: gridEmployeeCountry },
  {
    ...
    headerText: 'Passport',
    headerText_ar: 'ناريخ التسجيل',
    width: '135',
    textAlign: 'Center' },
];
export const vistorsGrid = [
  { field: 'id',
    headerText: 'ID',
    width: '60',
    textAlign: 'Center' },
...
export const staffGrid = [
  ...
  { field: 'phone',
    headerText: 'Phone',
    headerText_ar: 'رقم الجوال',
    width: '170',
    textAlign: 'Center',
  },
  { field: 'id_number',
  headerText: 'ID Number',
  headerText_ar: 'رقم الهويلة',
  width: '170',
  textAlign: 'Center',
},
  { field: 'username',
  headerText: 'Email',
  headerText_ar: 'اسم المستخدم',
  width: '170',
  textAlign: 'Center',
},
  { field: 'id',
    headerText: 'Staff ID',
    headerText_ar: 'رقم الموظف',
    width: '125',
    textAlign: 'Center' },
];
...
export const guaranteeData = [
  {
    ...
    WorkerName: 'Marketing Head',
    GuaranteeDate: '01/12/2023'
  },
  {
    GuaranteeID: 2,
    ClientName: 'Nancy Davolio',
...
export const finishedData = [
  {
    ID: '1',
    ClientName: 'Nancy Davolio',
    ClientPhone: '9668752143',
    WorkerName: 'Jhon Doe',
    WorkerPassport: '329815',
    OrderStatus: 'Done'
  },
  {
    ID: '2',
...
export const UnFinishedhGrid = [
  ...
  { field: 'WorkerName',
    ...
    textAlign: 'Center' },
  {
    field: 'WorkerPassport',
    headerText: 'Worker Passport',
    width: '120',
    textAlign: 'Center',
  },
  {
